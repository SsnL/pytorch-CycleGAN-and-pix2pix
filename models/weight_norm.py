"""
Modified from https://github.com/pytorch/pytorch/blob/master/torch/nn/utils/weight_norm.py
...
class WeightNorm(object):
    ...
    def compute_weight(self):
        ...
        return v * (g / self.norm(v)).expand_as(v)
    ...
    def apply(module, name, dim):
        ...
        setattr(module, name, fn.compute_weight())
    ...
    def __call__(self, inputs):
        ...
        return self.orig_forward(inputs)
